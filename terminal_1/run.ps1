...
$jupyterToken = (docker-compose exec research printenv JUPYTER_TOKEN).Trim()
...
Write-Host "Access JupyterLab at: http://localhost:8888 (Token: $jupyterToken)" -ForegroundColor Cyan
Write-Host "Access Grafana at: http://localhost:3000 (Credentials in .env)" -ForegroundColor Cyan
